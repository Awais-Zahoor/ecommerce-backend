...
const Sidebar = ({ showSidebar, setShowSidebar }) => {
    ...
    return (
        <div className={`fixed inset-y-0 left-0 z-40 w-64 h-full lg:static lg:translate-x-0 border-r border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-950 flex flex-col transition-all duration-300 ease-in-out ${showSidebar ? 'translate-x-0 shadow-2xl' : '-translate-x-full'}`}>
