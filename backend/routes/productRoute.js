...
import { listProducts,addProduct,removeProduct,singleProduct,updateStatus, updateProduct, updateStock } from '../controllers/productController.js';
...
productRouter.post('/update-status',adminAuth,updateStatus);
